...
@pytest.mark.parametrize(
    ...
    [
        urls.Campaigns.LIST,
        urls.CharacterBlueprints.SECTIONS,
...
async def test_cached_route_with_default_ttl(
    ...
    """Verify routes with cache=True use the default TTL from settings."""
    # Given a request to a cached endpoint using the default TTL
    url = build_url(url_name)
