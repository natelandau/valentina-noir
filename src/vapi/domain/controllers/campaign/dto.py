...
class CampaignResponse(msgspec.Struct):
    ...
    def from_model(cls, m: "Campaign") -> "CampaignResponse":
        ...
        return cls(
            ...
            num_books=m.num_books,  # type: ignore[attr-defined] # ty:ignore[unresolved-attribute]
            num_chapters=m.num_chapters,  # type: ignore[attr-defined]  # ty:ignore[unresolved-attribute]
            num_notes=m.num_notes,  # type: ignore[attr-defined]  # ty:ignore[unresolved-attribute]
            num_player_characters=m.num_player_characters,  # type: ignore[attr-defined]  # ty:ignore[unresolved-attribute]
            num_storyteller_characters=m.num_storyteller_characters,  # type: ignore[attr-defined]  # ty:ignore[unresolved-attribute]
            num_npc_characters=m.num_npc_characters,  # type: ignore[attr-defined]  # ty:ignore[unresolved-attribute]
...
class CampaignBookResponse(msgspec.Struct):
    ...
    def from_model(cls, m: "CampaignBook") -> "CampaignBookResponse":
        ...
        return cls(
            ...
            num_chapters=m.num_chapters,  # type: ignore[attr-defined] # ty:ignore[unresolved-attribute]
            num_notes=m.num_notes,  # type: ignore[attr-defined] # ty:ignore[unresolved-attribute]
            num_assets=m.num_assets,  # type: ignore[attr-defined] # ty:ignore[unresolved-attribute]
...
class CampaignBookDetailResponse(CampaignBookResponse, omit_defaults=True):
    ...
    def from_model(
        ...
        return cls(**fields)  # type: ignore[arg-type]  # ty:ignore[invalid-argument-type]
