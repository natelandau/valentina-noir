...
from vapi.lib.guards import developer_company_user_guard, storyteller_character_access_guard
...
class StatisticsController(Controller):
    ...
    guards = [developer_company_user_guard, storyteller_character_access_guard]
