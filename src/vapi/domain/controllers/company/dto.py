...
class CompanyResponse(msgspec.Struct):
    ...
    def from_model(cls, m: "Company") -> "CompanyResponse":
        ...
        return cls(
            ...
            num_campaigns=m.num_campaigns,  # type: ignore[attr-defined]  # ty:ignore[unresolved-attribute]
            ...
            num_users=m.num_users,  # type: ignore[attr-defined]  # ty:ignore[unresolved-attribute]
