...
OPERATION_ID_ENTITY_MAP: dict[str, AuditEntityType] = {
    ...
    "registerSSOUser": AuditEntityType.USER,
    ...
    "createBook": AuditEntityType.BOOK,
    "createChapter": AuditEntityType.CHAPTER,
    "createCharacter": AuditEntityType.CHARACTER,
    "autogenerateCharacter": AuditEntityType.CHARACTER,
    "startChargen": AuditEntityType.CHARGEN_SESSION,
    "finalizeChargen": AuditEntityType.CHARACTER,
    "createCharacterTrait": AuditEntityType.CHARACTER_TRAIT,
    "assignCharacterTrait": AuditEntityType.CHARACTER_TRAIT,
    "bulkAssignCharacterTraits": AuditEntityType.CHARACTER_TRAIT,
    "createInventoryItem": AuditEntityType.CHARACTER_INVENTORY,
    "createDictionaryTerm": AuditEntityType.DICTIONARY_TERM,
    "createNote": AuditEntityType.NOTE,
    ...
    "createQuickroll": AuditEntityType.QUICKROLL,
    "addXp": AuditEntityType.EXPERIENCE,
    "removeXp": AuditEntityType.EXPERIENCE,
    "addCp": AuditEntityType.EXPERIENCE,
    "createCompany": AuditEntityType.COMPANY,
    "createDeveloper": AuditEntityType.DEVELOPER,
}
