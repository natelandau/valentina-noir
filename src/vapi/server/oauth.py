"""OAuth2 server configuration plugin."""
...
type AccessTokenState = tuple[OAuth2Token, str | None]
...
class OAuth2AuthorizeCallback:
    ...
    **Example**
    ...
    def __init__(
        ...
        """Initialize the OAuth2AuthorizeCallback.
    ...
    async def __call__(
        ...
        Args:
            ...
            code (str | None): The code parameter.
            code_verifier (str | None): The code verifier parameter.
            callback_state (str | None): The state parameter.
            error (str | None): The error parameter.Z
        """
