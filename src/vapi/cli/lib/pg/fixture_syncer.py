"""PostgreSQL fixture syncer base class and simple subclasses."""
...
from vapi.cli.lib.pg import SyncCounts
...
class PgWerewolfAuspiceSyncer(PgFixtureSyncer):
...
class PgWerewolfTribeSyncer(PgFixtureSyncer):
...
class PgCharacterConceptSyncer(PgFixtureSyncer):
...
class PgVampireClanSyncer(PgFixtureSyncer):
