...
-   **[Companies](../development/companies/)** - Companies are the foundational entity in Valentina Noir. Each company is a distinct entity with its own set of users, campaigns, and characters, etc.

-   **[End Users](../development/user-management/)** - End users are the players and storytellers who interact with the Valentina Noir API. They are the ones who create and manage characters, campaigns, and other resources.
...
-   **[Characters](../core-concepts/characters/)** - Characters are the players and NPCs in a campaign.
